 ...
 * @author dec
 */
public class GuessYouLikeProductInfo {
	...
	public String toString() {
		return "GuessYouLikeProductInfo [merchsid=" + merchsid + ", loc=" + loc + ", image="
	...
	public GuessYouLikeProductInfo(){
		
	}
	
	
	public GuessYouLikeProductInfo(Integer merchsid, String loc, String image, String range,
